        ...
        <div className="space-y-6 overflow-x-hidden">
                    ...
                    <div className="flex-1 min-w-[200px]">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pr-10 pl-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm"
                            />
                        </div>
                    </div>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {filteredPayments.length > 0 ? (
                                ...
                                <tr>
                                    ...
                                    >
                                        <i className="ri-money-dollar-circle-line text-6xl text-gray-300 mb-4 block"></i>
                                        <h3 className="text-lg font-medium text-gray-900 mb-2">
                                            لا توجد مدفوعات
                                        </h3>
                                        <p className="text-gray-500">
                                            لم يتم العثور على مدفوعات تطابق
                                            الفلتر المحدد
                                        </p>
                                    </td>
                                </tr>
            ...
            {showDetailsModal && selectedPayment && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto custom-scrollbar-left">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex space-x-4 border-t border-gray-200 pt-4">
                                ...
                                <button
                                    ...
                                    className="flex-1 bg-green-500 hover:bg-green-600 text-white py-3 rounded-lg font-medium transition-colors whitespace-nowrap cursor-pointer flex items-center justify-center gap-2"
                                >
                    ...
                    <div className="bg-white rounded-lg p-6 w-full max-w-md">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <button
                                ...
                                className="flex-1 bg-red-500 hover:bg-red-600 text-white py-2 rounded-lg font-medium transition-colors cursor-pointer"
                            >
                                حذف
                            </button>
                        </div>
