  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {recentOrders.map((order, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 mb-1">{order.table}</p>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">الأطباق الأكثر طلباً</h3>
            <button className="text-orange-500 hover:text-orange-600 text-sm font-medium cursor-pointer">
              عرض التقرير
            </button>
          </div>
              ...
              <div key={index} className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{dish.orders} طلب</p>
                  </div>
                </div>
                <div className="text-right">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-xs text-gray-500">{Math.round((dish.orders / 45) * 100)}%</span>
                  </div>
                </div>
              </div>
            ))}
      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <button className="flex flex-col items-center p-3 bg-orange-50 hover:bg-orange-100 rounded-lg transition-colors cursor-pointer">
            <div className="w-8 h-8 flex items-center justify-center mb-2">
              <i className="ri-add-line text-xl text-orange-500"></i>
            </div>
            <span className="text-sm font-medium text-gray-900">إضافة طبق جديد</span>
          </button>
          <button className="flex flex-col items-center p-3 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors cursor-pointer">
            <div className="w-8 h-8 flex items-center justify-center mb-2">
              <i className="ri-qr-code-line text-xl text-blue-500"></i>
            </div>
            <span className="text-sm font-medium text-gray-900">إنشاء رمز QR</span>
          </button>
          <button className="flex flex-col items-center p-3 bg-green-50 hover:bg-green-100 rounded-lg transition-colors cursor-pointer">
            <div className="w-8 h-8 flex items-center justify-center mb-2">
              <i className="ri-file-chart-line text-xl text-green-500"></i>
            </div>
            <span className="text-sm font-medium text-gray-900">تقرير المبيعات</span>
          </button>
          <button className="flex flex-col items-center p-3 bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors cursor-pointer">
            <div className="w-8 h-8 flex items-center justify-center mb-2">
              <i className="ri-settings-line text-xl text-purple-500"></i>
            </div>
            <span className="text-sm font-medium text-gray-900">إعدادات المطعم</span>
          </button>
        </div>
      </div>
    </div>
