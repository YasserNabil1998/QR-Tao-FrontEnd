...
export default function MenuManagement() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      category: 'main',
      price: '55.00',
      description: 'بيتزا إيطالية كلاسيكية مع الطماطم والموزاريلا والريحان',
    ...
    <div className="space-y-6">
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <select className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 pr-8">
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200">
                      <th className="text-right py-3 px-4 font-medium text-gray-900">الصنف</th>
                      ...
                      <th className="text-right py-3 px-4 font-medium text-gray-900">الطلبات</th>
                      <th className="text-right py-3 px-4 font-medium text-gray-900">الإيرادات</th>
                  ...
                  <tbody>
                    {filteredItems.map((item) => (
                      <tr key={item.id} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="py-4 px-4 font-medium text-gray-900">{item.price} ر.س</td>
                        <td className="py-4 px-4 text-gray-600">{item.orders}</td>
                        <td className="py-4 px-4 font-medium text-gray-900">{item.revenue}</td>
                        <td className="py-4 px-4">
                        ...
                        <td className="py-4 px-4">
                          <div className="flex items-center space-x-2">
                            ...
                            <button className="w-8 h-8 flex items-center justify-center text-gray-400 hover:text-green-500 transition-colors cursor-pointer">
      ...
      {activeTab === 'categories' && (
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900">إدارة الفئات</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900">إجمالي الأصناف</h3>
                <i className="ri-restaurant-line text-2xl text-orange-500"></i>
              </div>
              <p className="text-3xl font-bold text-gray-900">45</p>
              <p className="text-sm text-green-600">+3 هذا الشهر</p>
            </div>
            
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900">متوسط السعر</h3>
                <i className="ri-money-dollar-circle-line text-2xl text-green-500"></i>
              </div>
              <p className="text-3xl font-bold text-gray-900">42.50 ر.س</p>
              <p className="text-sm text-blue-600">+5% من الشهر الماضي</p>
            </div>
            
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900">الأكثر طلباً</h3>
                <i className="ri-fire-line text-2xl text-red-500"></i>
              </div>
              <p className="text-lg font-bold text-gray-900">برجر كلاسيك</p>
              <p className="text-sm text-gray-600">156 طلب هذا الشهر</p>
            </div>
          </div>

          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-900 mb-6">أداء الفئات</h3>
            <div className="space-y-4">
              {categories.filter(c => c.id !== 'all').map((category, index) => (
                <div key={category.id} className="flex items-center justify-between">
                  <div className="flex items-center">
                    <div className="w-4 h-4 bg-orange-500 rounded-full ml-3" style={{
                      backgroundColor: ['#f97316', '#3b82f6', '#10b981', '#8b5cf6'][index]
                    }}></div>
                    <span className="font-medium text-gray-900">{category.name}</span>
                  </div>
                  <div className="flex items-center space-x-4">
                    <span className="text-sm text-gray-600">{category.count} صنف</span>
                    ...
                    <span className="text-sm font-medium text-gray-900">
                      {Math.round((category.count / 45) * 100)}%
                    </span>
                  </div>
                </div>
              ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 pr-8">
                    ...
                    <option>المقبلات</option>
                    <option>الأطباق الرئيسية</option>
