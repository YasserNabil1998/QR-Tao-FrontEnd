            ...
            <section className="py-20 bg-gradient-to-br from-orange-50 to-red-50">
                <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                        نحن فريق متخصص في تطوير حلول تقنية مبتكرة لصناعة المطاعم
                        والضيافة في المنطقة العربية
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                                <p>
                                    بدأت رحلة QTap في عام 2020 عندما لاحظنا
                                    التحديات التي تواجه المطاعم في المنطقة
                                    العربية، خاصة مع تزايد الطلب على الحلول
                                    الرقمية والتجارب اللاتلامسية.
                                </p>
                                <p>
                                    أسسنا الشركة بهدف واضح: تمكين المطاعم من
                                    تقديم تجربة طعام حديثة ومريحة لعملائها، مع
                                    الحفاظ على الطابع الثقافي والاجتماعي المميز
                                    للمنطقة العربية.
                                </p>
                                <p>
                                    اليوم، نفخر بخدمة أكثر من 500 مطعم في أكثر
                                    من 40 مدينة عربية، ونواصل الابتكار لتطوير
                                    حلول تقنية تلبي احتياجات السوق المحلي.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <div className="bg-white rounded-2xl p-8 shadow-lg">
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                تمكين المطاعم العربية من تحويل تجربة الطعام إلى
                                رحلة رقمية مميزة، من خلال توفير حلول تقنية
                                مبتكرة وسهلة الاستخدام تحافظ على الهوية الثقافية
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg">
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                أن نكون الشريك التقني الأول للمطاعم في المنطقة
                                العربية، ونساهم في بناء مستقبل رقمي مستدام
                                لصناعة الضيافة، مع الحفاظ على التراث الثقافي
                                والقيم الاجتماعية للمنطقة.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            القيم التي توجه عملنا وتحدد طريقة تفاعلنا مع عملائنا
                            وشركائنا
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600">
                                نسعى دائماً لتطوير حلول مبتكرة تواكب التطورات
                                التقنية وتلبي احتياجات السوق
                            </p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600">
                                نؤمن بقوة الشراكات طويلة المدى ونعمل مع عملائنا
                                كفريق واحد لتحقيق النجاح
                            </p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600">
                                نحب ما نعمل ونتفانى في تقديم أفضل الحلول التقنية
                                لصناعة المطاعم
                            </p>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gray-50">
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            فريق متنوع من الخبراء والمتخصصين في التقنية وصناعة
                            المطاعم
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
                            ...
                            <p className="text-gray-600 text-sm">
                                خبرة 15 عاماً في مجال التقنية وريادة الأعمال،
                                متخصص في تطوير الحلول الرقمية للشركات
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
                            ...
                            <p className="text-gray-600 text-sm">
                                خبيرة في تطوير البرمجيات وأنظمة قواعد البيانات،
                                حاصلة على ماجستير في علوم الحاسوب
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
                            ...
                            <p className="text-gray-600 text-sm">
                                متخصص في التسويق الرقمي وإدارة العلاقات مع
                                العملاء، خبرة 10 سنوات في السوق العربي
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-20 bg-gradient-to-r from-orange-500 to-red-500">
                <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
                    ...
                    <p className="text-xl text-orange-100 mb-8 max-w-3xl mx-auto">
                        نحن هنا للإجابة على جميع استفساراتك ومساعدتك في اتخاذ
                        القرار المناسب لمطعمك
                    </p>
