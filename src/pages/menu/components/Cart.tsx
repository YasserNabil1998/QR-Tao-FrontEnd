...
const Cart = ({ cart, onUpdateItem, onRemoveItem, onClose, onCheckout, totalAmount }: CartProps) => {
  return (
        ...
        <div className="flex-1 overflow-y-auto p-4 max-h-96">
          {cart.length === 0 ? (
            ...
            <div className="space-y-4">
              {cart.map((item) => (
                <div key={item.cartId} className="flex items-center space-x-4 space-x-reverse bg-gray-50 rounded-lg p-3">
                  ...
                  <div className="flex items-center space-x-2 space-x-reverse">
                    <button
                      onClick={() => onUpdateItem(item.cartId, item.quantity - 1)}
