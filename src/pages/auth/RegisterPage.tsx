    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <div className="mx-auto w-20 h-20 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
        ...
        <div className="flex items-center justify-center space-x-4 mb-8">
          ...
          <div className={`w-12 h-1 ${currentStep >= 2 ? 'bg-orange-500' : 'bg-gray-200'}`}></div>
          <div className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium ${
            currentStep >= 2 ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-600'
          }`}>
            2
          </div>
          <div className={`w-12 h-1 ${currentStep >= 3 ? 'bg-orange-500' : 'bg-gray-200'}`}></div>
          <div className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium ${
            ...
            {error && (
              <div className="bg-red-50 border-l-4 border-red-400 p-4 rounded-lg">
                <div className="flex">
                  ...
                  <div className="mr-3">
                    <p className="text-sm text-red-7
...
0">{error}</p>
            ...
            {currentStep === 1 && (
              <div className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-600">أدخل معلومات المطعم الأساسية</p>
                </div>
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-600">اختر كلمة مرور قوية لحسابك</p>
                </div>
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-600">معلومات اختيارية لتحسين تجربتك</p>
                </div>
        ...
        <div className="text-center">
          <p className="text-xs text-gray-500 max-w-sm mx-auto">
            ...
            <Link to="/legal/terms" className="text-orange-600 hover:text-orange-500">شروط الخدمة</Link>
            {' '}و{' '}
            <Link to="/legal/privacy" className="text-orange-600 hover:text-orange-500">سياسة الخصوصية</Link>
