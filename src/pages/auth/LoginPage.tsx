          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-gray-500 font-medium">حسابات تجريبية</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid gap-3">
              <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-xl border border-blue-200">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-semibold text-blue-900 text-sm">مدير المطعم</p>
                    <p className="text-blue-700 text-xs">admin@restaurant.com</p>
                  </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-green-100 p-4 rounded-xl border border-green-200">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-semibold text-green-900 text-sm">الكاشير</p>
                    <p className="text-green-700 text-xs">cashier@restaurant.com</p>
                  </div>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-purple-100 p-4 rounded-xl border border-purple-200">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-semibold text-purple-900 text-sm">الشيف</p>
                    <p className="text-purple-700 text-xs">chef@restaurant.com</p>
                  </div>
            ...
            <p className="text-center text-xs text-gray-500 mt-4">
              كلمة المرور لجميع الحسابات: <span className="font-mono bg-gray-100 px-2 py-1 rounded">123456</span>
            </p>
          </div>
