...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://readdy.ai/api/form/contact-form-qtap', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="min-h-screen bg-white font-arabic">
      ...
      <section className="py-20 bg-gradient-to-br from-orange-50 to-red-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            نحن هنا لمساعدتك في كل خطوة من رحلتك الرقمية. تواصل معنا وسنكون سعداء للإجابة على استفساراتك
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">اتصل بنا</h3>
              <p className="text-gray-600 mb-2">+966 11 123 4567</p>
              <p className="text-gray-600 mb-2">+966 50 987 6543</p>
              <p className="text-gray-500 text-sm">متاح 24/7 لخدمتك</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">راسلنا</h3>
              <p className="text-gray-600 mb-2">support@qtap.sa</p>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">زورنا</h3>
              <p className="text-gray-600 mb-2">الرياض، المملكة العربية السعودية</p>
              <p className="text-gray-600 mb-2">مركز الملك عبدالله المالي</p>
              <p className="text-gray-500 text-sm">الأحد - الخميس: 9 ص - 6 م</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            <form onSubmit={handleSubmit} data-readdy-form id="contact-form">
              ...
              {submitMessage && (
                <div className={`mt-4 text-center text-sm ${submitMessage.includes('بنجاح') ? 'text-green-600' : 'text-red-600'}`}>
                  {submitMessage}
                </div>
              )}
            </form>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">موقعنا</h2>
            <p className="text-xl text-gray-600">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg p-6 shadow-md">
              <h3 className="text-lg font-bold text-gray-900 mb-3">كم يستغرق تطبيق النظام في مطعمي؟</h3>
              <p className="text-gray-600">
                عادة ما يستغرق التطبيق من 2-5 أيام عمل، حسب حجم المطعم وتعقيد القائمة. 
                فريقنا سيساعدك في كل خطوة لضمان انتقال سلس.
              </p>
            </div>

            <div className="bg-white rounded-lg p-6 shadow-md">
              <h3 className="text-lg font-bold text-gray-900 mb-3">هل يمكنني تجربة النظام قبل الاشتراك؟</h3>
              <p className="text-gray-600">
                نعم، نوفر تجربة مجانية لمدة 14 يوم مع إمكانية الوصول لجميع المميزات. 
                كما يمكنك مشاهدة العرض التوضيحي المباشر على موقعنا.
              </p>
            </div>

            <div className="bg-white rounded-lg p-6 shadow-md">
              <h3 className="text-lg font-bold text-gray-900 mb-3">ما هي طرق الدفع المتاحة؟</h3>
              <p className="text-gray-600">
                نقبل جميع طرق الدفع الرئيسية: البطاقات الائتمانية، التحويل البنكي، 
                والمحافظ الرقمية مثل STC Pay و Apple Pay.
              </p>
            </div>

            <div className="bg-white rounded-lg p-6 shadow-md">
              <h3 className="text-lg font-bold text-gray-900 mb-3">هل تقدمون دعم فني على مدار الساعة؟</h3>
              <p className="text-gray-600">
                نعم، نوفر دعم فني متاح 24/7 عبر الهاتف والبريد الإلكتروني والدردشة المباشرة. 
                فريق الدعم لدينا مدرب ومتخصص في حل جميع المشاكل التقنية.
              </p>
            </div>
          </div>
        </div>
