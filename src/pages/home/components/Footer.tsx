    ...
    const handleNewsletterSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch(
                "https://readdy.ai/api/form/d3mcqt5es84r01urdgv0",
                {
                    method: "POST",
                    headers: {
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-gray-400 mb-6 leading-relaxed text-body-large">
                            نحن شركة تقنية متخصصة في رقمنة قطاع المطاعم من خلال
                            حلول مبتكرة وسهلة الاستخدام. نقدم نظام الطلب المبتكر
                            عبر رمز QR، والقوائم الرقمية القابلة للتخصيص،
                            والمدفوعات السلسة على الطاولة.
                        </p>

                        <div className="flex space-x-4">
                            <a
                                href="https://facebook.com/qtap"
                                className="w-10 h-10 bg-gray-800 hover:bg-orange-500 rounded-full flex items-center justify-center transition-colors cursor-pointer"
                            >
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <a
                                    href="#features"
                                    className="footer-text text-gray-400 hover:text-orange-400 transition-colors cursor-pointer"
                                >
                                    المميزات الأساسية
                                </a>
                            </li>
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
                        <div>
                            ...
                            <p className="text-gray-400 text-body">
                                احصل على آخر الأخبار والتحديثات والنصائح المفيدة
                                حول QTap مباشرة في بريدك الإلكتروني
                            </p>
                        </div>
                ...
                <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-gray-400 footer-text">
                        © 2024 QTap. جميع الحقوق محفوظة. مسجل في المملكة العربية
                        السعودية.
                    </p>

                    <div className="flex items-center space-x-6">
                        <span className="text-gray-400 footer-text">
                            صُنع بـ ❤️ للمطاعم العربية
                        </span>
                        <a
