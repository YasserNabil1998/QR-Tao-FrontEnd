...
export default function Analytics() {
  ...
  const features = [
    {
      ...
      description: 'راقب أداء مطعمك لحظة بلحظة مع لوحة تحكم شاملة تعرض جميع المقاييس المهمة',
    ...
    {
      title: 'تقارير مفصلة',
      description: 'احصل على تقارير شاملة عن المبيعات، الأطباق الأكثر طلباً، أوقات الذروة، وأداء الفريق',
    ...
    },
    {
      ...
      description: 'استخدم قوة الذكاء الاصطناعي للتنبؤ بالطلب، تحسين المخزون، واتخاذ قرارات مدروسة',
      icon: 'ri-brain-line',
  ...
  return (
    <section id="analytics" className="py-20 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12">
            انضم إلى مجتمع متنامي من المطاعم الناجحة التي تستخدم QTap لتحقيق نتائج استثنائية
          </p>
        ...
        <div className="mt-20 text-center">
          <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-lg">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              احصل على رؤى عميقة حول أداء مطعمك واتخذ قرارات تعتمد على البيانات الحقيقية
            </p>
