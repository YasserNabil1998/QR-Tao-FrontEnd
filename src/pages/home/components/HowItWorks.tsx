    ...
    const steps = [
        {
            ...
            title: "امسح رمز QR",
            description:
                "يمسح العملاء رمز QR الفريد على طاولتهم للوصول الفوري للقائمة الرقمية",
        ...
        },
        {
            ...
            title: "تصفح واطلب",
            description:
                "استكشف القائمة المخصصة مع فيديوهات الأطباق والأوصاف والأسعار. أضف العناصر للسلة",
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        اختبر تجربة طعام سلسة في أربع خطوات بسيطة فقط. لا
                        تطبيقات للتحميل، لا انتظار للخدمة.
                    </p>
                </div>
                    ...
                    <div className="mt-16 bg-white rounded-2xl p-8 shadow-xl border-2 border-orange-200">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-600">
                                اختبر تجربة QTap الكاملة من خلال هذا العرض
                                التوضيحي التفاعلي
                            </p>
                        </div>
                                ...
                                <div className="bg-white rounded-lg p-4 shadow-md">
                                    <div className="text-center mb-4">
                                        <div className="w-16 h-16 bg-orange-500 rounded-full flex items-center justify-center mx-auto mb-3">
                                            <i
                                                className={`${steps[activeDemo].icon} text-white text-2xl`}
                                            ></i>
                                        </div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-2">
                                            تجربة {steps[activeDemo].title} مع
                                            نظام QTap الذكي
                                        </p>
                                    </div>

                                    <div className="space-y-3">
                                        {steps[activeDemo].demoFeatures.map(
                                            (feature, index) => (
                                                <div
                                                    key={index}
