                    ...
                    <div className="flex items-center space-x-4 space-x-reverse">
                        {user ? (
                            <div className="flex items-center space-x-4 space-x-reverse">
                                ...
                                <span className="text-gray-300 text-body">
                            ...
                            <Link
                                to="/register"
                                className="bg-[#1B6EF3] hover:bg-[#0D5DD9] text-white font-semibold px-6 py-2 rounded-lg shadow-lg transition-colors whitespace-nowrap"
                            >
                                ابدأ الآن
                            </Link>
                        )}
