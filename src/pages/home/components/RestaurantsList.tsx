...
const RestaurantsList = () => {
  ...
  const mockRestaurants: Restaurant[] = [
    ...
    },
    {
      ...
      rating: 4.4,
      total_reviews: 312,
      image_url: 'https://readdy.ai/api/search-image?query=Modern%20fast%20food%20restaurant%20interior%2C%20burger%20station%2C%20quick%20service%20setup%2C%20contemporary%20casual%20dining%2C%20efficient%20kitchen%20design%2C%20simple%20clean%20background&width=400&height=300&seq=fast-food-1&orientation=landscape',
      is_active: true,
      phone: '+966506789012',
    ...
    },
    {
      ...
      rating: 4.5,
      total_reviews: 234,
      image_url: 'https://readdy.ai/api/search-image?query=Specialized%20pizza%20shop%20interior%2C%20wood-fired%20pizza%20oven%2C%20pizza%20preparation%20counter%2C%20Italian%20style%20design%2C%20authentic%20pizzeria%20atmosphere%2C%20simple%20clean%20background&width=400&height=300&seq=pizza-shop-1&orientation=landscape',
      is_active: true,
      phone: '+966508901234',
    ...
    },
    {
      ...
      rating: 4.6,
      total_reviews: 189,
      image_url: 'https://readdy.ai/api/search-image?query=Traditional%20bakery%20interior%2C%20fresh%20bread%20display%2C%20baking%20ovens%2C%20warm%20atmosphere%2C%20artisan%20bakery%20design%2C%20flour%20and%20dough%20workspace%2C%20simple%20clean%20background&width=400&height=300&seq=bakery-1&orientation=landscape',
      is_active: true,
      phone: '+966509012345',
    ...
    },
    {
      ...
      rating: 4.8,
      total_reviews: 223,
      image_url: 'https://readdy.ai/api/search-image?query=Modern%20specialty%20coffee%20shop%20interior%2C%20professional%20coffee%20equipment%2C%20minimalist%20design%2C%20industrial%20elements%2C%20cozy%20atmosphere%2C%20simple%20clean%20background&width=400&height=300&seq=cafe-2&orientation=landscape',
      is_active: true,
      phone: '+966514567890',
    ...
    },
    {
      ...
      rating: 4.5,
      total_reviews: 267,
      image_url: 'https://readdy.ai/api/search-image?query=Traditional%20countryside%20bakery%20interior%2C%20rustic%20bread%20ovens%2C%20artisan%20baking%20setup%2C%20homestyle%20atmosphere%2C%20authentic%20bakery%20design%2C%20simple%20clean%20background&width=400&height=300&seq=bakery-2&orientation=landscape',
      is_active: true,
      phone: '+966519012345',
    ...
    },
    {
      ...
      rating: 4.1,
      total_reviews: 134,
      image_url: 'https://readdy.ai/api/search-image?query=Burger%20food%20truck%20interior%2C%20mobile%20grill%20setup%2C%20compact%20burger%20kitchen%2C%20street%20food%20atmosphere%2C%20efficient%20mobile%20cooking%20space%2C%20simple%20clean%20background&width=400&height=300&seq=food-truck-2&orientation=landscape',
      is_active: true,
      phone: '+966520123456',
      opening_hours: '12:00 ظ - 12:00 م'
    },
    {
      ...
      rating: 4.6,
      total_reviews: 198,
      image_url: 'https://readdy.ai/api/search-image?query=Tropical%20fruit%20market%20interior%2C%20exotic%20fruits%20display%2C%20fresh%20juice%20bar%2C%20vibrant%20colorful%20atmosphere%2C%20healthy%20food%20store%20design%2C%20simple%20clean%20background&width=400&height=300&seq=fruit-store-2&orientation=landscape',
      is_active: true,
      phone: '+966521234567',
  ...
  const categories = [
    ...
    { id: 'الوجبات السريعة', name: 'الوجبات السريعة', icon: 'ri-takeaway-line' },
  ...
  const filteredRestaurants = restaurants.filter(restaurant => {
    return selectedCategory === 'all' || restaurant.cuisine_type === selectedCategory
  })
    ...
    <section className="py-20 bg-gradient-to-br from-orange-50 to-orange-100">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full text-white text-2xl font-bold mb-6">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            اكتشف مجموعة متنوعة من المطاعم والمتاجر والخدمات التي تستخدم نظام QTap لتقديم تجربة رقمية مميزة
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          {categories.map((category) => (
            ...
            >
              <i className={`${category.icon} ml-2 w-5 h-5 flex items-center justify-center`}></i>
              {category.name}
            </button>
          ))}
        </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-3">
                    ...
                    <span className="text-gray-600 text-sm mr-2">
                      {restaurant.rating} ({restaurant.total_reviews} تقييم)
                    </span>
                  </div>
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <div className="flex items-center text-gray-600 text-sm">
                      <i className="ri-time-line ml-2 w-4 h-4 flex items-center justify-center"></i>
                      <span>{restaurant.opening_hours}</span>
                    </div>
                    <div className="flex items-center text-gray-600 text-sm">
                      <i className="ri-phone-line ml-2 w-4 h-4 flex items-center justify-center"></i>
                      <span>{restaurant.phone}</span>
                    </div>
                  </div>

                  <div className="flex space-x-3 space-x-reverse">
                    {restaurant.cuisine_type === 'مطعم' || restaurant.cuisine_type === 'مقهى' || restaurant.cuisine_type === 'مطعم الفندق' || restaurant.cuisine_type === 'الوجبات السريعة' || restaurant.cuisine_type === 'متجر بيتزا' || restaurant.cuisine_type === 'شاحنة طعام' ? (
                      <Link
                        to={`/menu?restaurant=${restaurant.id}&table=1`}
                        className="flex-1 bg-orange-500 hover:bg-orange-600 text-white text-center py-3 px-4 rounded-lg font-medium transition-colors whitespace-nowrap"
                      >
                        <i className="ri-restaurant-line ml-1"></i>
                        عرض المنيو
                      </Link>
                    ) : (
                      <button className="flex-1 bg-green-500 hover:bg-green-600 text-white text-center py-3 px-4 rounded-lg font-medium transition-colors whitespace-nowrap cursor-pointer">
                        <i className="ri-shopping-cart-line ml-1"></i>
                        تسوق الآن
                      </button>
                    )}
                    <button className="bg-gray-100 hover:bg-gray-200 text-gray-700 p-3 rounded-lg transition-colors cursor-pointer">
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-orange-100 mb-6 max-w-2xl mx-auto">
              انضم إلى شبكة الشركاء الرائدة واستفد من نظام QTap لتحسين تجربة عملائك وزيادة مبيعاتك
            </p>
            <Link
              to="/register"
