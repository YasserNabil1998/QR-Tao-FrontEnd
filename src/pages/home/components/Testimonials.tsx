  ...
  const testimonials = [
    {
      ...
      content: 'QTap غيّر طريقة عمل مطعمنا بالكامل. زادت الطلبات بنسبة 40% وقل وقت الانتظار بشكل كبير. العملاء يحبون سهولة الطلب عبر الهاتف.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'منذ استخدام QTap، أصبح بإمكان عملائنا الطلب بسهولة دون انتظار النادل. النظام سهل الاستخدام ووفر علينا الكثير من الوقت والجهد.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'نستخدم QTap في جميع فروعنا الـ 8. النظام موحد ويساعدنا في إدارة العمليات بكفاءة. التقارير التفصيلية تساعدنا في اتخاذ قرارات أفضل.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'أفضل استثمار قمنا به! QTap ساعدنا في تحسين تجربة العملاء وزيادة الإيرادات. الدعم الفني ممتاز والنظام لا يتوقف أبداً.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'كنت متردداً في البداية، لكن بعد تجربة QTap لمدة شهر، لا أستطيع تخيل العمل بدونه. العملاء سعداء والعمليات أصبحت أكثر تنظيماً.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'QTap ليس مجرد نظام طلبات، بل شريك في النجاح. ساعدنا في فهم تفضيلات العملاء وتحسين قائمة الطعام بناءً على البيانات الحقيقية.',
      rating: 5,
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            انضم إلى مئات المطاعم التي تثق في QTap لتحسين عملياتها وزيادة أرباحها
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-center justify-center">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-orange-600">{testimonial.restaurant}</p>
                </div>
              </div>
            </div>
          ))}
