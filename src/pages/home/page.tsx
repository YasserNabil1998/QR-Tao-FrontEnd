        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-tajawal">
              نحن نؤمن بأن تجربة العميل هي أساس نجاح أي مطعم. لذلك صممنا QTap ليقدم تجربة سلسة ومميزة
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-orange-50 to-red-50">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-orange-500 to-red-500 rounded-full text-white text-2xl font-bold mb-8">
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed font-tajawal">
              انضم إلى شبكة الشركاء الرائدة استفيد من نظام QTap لتحسين تجربة عملائك وزيادة مبيعاتك
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4 font-cairo">زيادة المبيعات</h3>
                <p className="text-gray-600 font-tajawal">احصل على المزيد من الطلبات وزيد إيراداتك مع نظام الطلب الرقمي المتطور</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4 font-cairo">تجربة عملاء مميزة</h3>
                <p className="text-gray-600 font-tajawal">قدم تجربة طعام حديثة ومريحة لعملائك مع القوائم الرقمية التفاعلية</p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4 font-cairo">إدارة محسنة</h3>
                <p className="text-gray-600 font-tajawal">تحكم كامل في مطعمك مع لوحة تحكم شاملة وتقارير تفصيلية</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl p-8 md:p-12 text-white">
              ...
              <p className="text-orange-100 mb-8 text-lg font-tajawal">
                انضم إلى أكثر من 500 مطعم يثق بنظام QTap لإدارة أعمالهم
              </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-12">
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-orange-500 mb-2 font-cairo">500+</div>
                <div className="text-gray-600 font-tajawal">شريك نشط</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-orange-500 mb-2 font-cairo">50K+</div>
                <div className="text-gray-600 font-tajawal">طلب يومي</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-orange-500 mb-2 font-cairo">40+</div>
                <div className="text-gray-600 font-tajawal">مدينة</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-orange-500 mb-2 font-cairo">99%</div>
                <div className="text-gray-600 font-tajawal">رضا الشركاء</div>
              </div>
            </div>
          </div>
        </div>
